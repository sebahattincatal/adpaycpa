...
<p>
	<b><?php echo $loc['offers.php']['t155']; ?>&nbsp;</b>[<a href="./offers.php?addoffer=ok"><?php echo $loc['offers.php']['t150']; ?></a>]
</p>
		...
		while($res=mysqli_fetch_array($result)) 
			...
			<table class="stats_table" style="width: 100%; margin: 15px 0px 15px 0px;">
				<tr class="<?php if ( $cvet & 1 ) {echo 'col2';} else {echo '';} $cvet++; ?>">
					...
					<td width="110"><?php if (isset($offer_cena) && $offer_cena!='0') {echo $offer_cena.'&nbsp;'.$loc['offers.php']['t17'].'&nbsp;';} else {?>&nbsp;<?php echo $loc['offers.php']['t29']; ?>&nbsp;<?php } ?></td>	
					<td width="110">
						<?php 
