...
<p>
	...
	<form id="filter" method="post" action="./stats.php">
		<div class="v_odin_ryad">
			...
			<p>
				<span>
					<b><?php echo $loc['stats.php']['t05']; ?>&nbsp;</b>
					<select name="subid1" style="text-align: left; width: 126px; height: 25px;">
						<option class="options" value="0" <?php if (isset($_POST['submit']) && isset($_POST['subid1']) && $_POST['subid1']=="0") { ?>selected="selected"<?php } ?>><?php echo $loc['stats.php']['t04']; ?></option>
						<?php
						// Получаем список subid1
						// Get the list subid1
						$subids1 = get_subid($user_id, 1);
						if ($subids1!=null)
							{
							foreach($subids1 as $subid1)
								{
								$subid1=htmlentities($subid1);
								echo '<option value="'.$subid1.'" ';
								if(isset($_POST['subid1']) && $_POST['subid1'] == $subid1) echo 'selected';
								echo '>'.$subid1.'</option>';
								}
							}
						?>
				...
				<span>
					<b><?php echo $loc['stats.php']['t06']; ?>&nbsp;</b>
					<select name="subid2" style="text-align: left; width: 126px; height: 25px;">
						<option class="options" value="0" <?php if (isset($_POST['submit']) && isset($_POST['subid2']) && $_POST['subid2']=="0") { ?>selected="selected"<?php } ?>><?php echo $loc['stats.php']['t04']; ?></option>
						<?php
						// Получаем список subid2
						// Get the list subid2
						$subids1 = get_subid($user_id, 2);
						if ($subids1!=null)
							{
							foreach($subids1 as $subid1)
								{
								$subid1=htmlentities($subid1);
								echo '<option value="'.$subid1.'" ';
								if(isset($_POST['subid2']) && $_POST['subid2'] == $subid1) echo 'selected';
								echo '>'.$subid1.'</option>';
								}
							}
						?>
				...
				<span>
					<b><?php echo $loc['stats.php']['t07']; ?>&nbsp;</b>
					<select name="subid3" style="text-align: left; width: 126px; height: 25px;">
						<option class="options" value="0" <?php if (isset($_POST['submit']) && isset($_POST['subid3']) && $_POST['subid3']=="0") { ?>selected="selected"<?php } ?>><?php echo $loc['stats.php']['t04']; ?></option>
						<?php
						// Получаем список subid3
						// Get the list subid3
						$subids1 = get_subid($user_id, 3);
						if ($subids1!=null)
							{
							foreach($subids1 as $subid1)
								{
								$subid1=htmlentities($subid1);
								echo '<option value="'.$subid1.'" ';
								if(isset($_POST['subid3']) && $_POST['subid3'] == $subid1) echo 'selected';
								echo '>'.$subid1.'</option>';
								}
							}
						?>
		...
		<div class="v_odin_ryad">
			<p>
				<input name="submit" value="<?php echo $loc['button']['t02']; ?>" class="others_button_vyvesti" type="submit">
				<br />
...
<p>
	<table class="stats_table" width="100%">
		...
		<tr style="background: #e1ecf5;">
			...
			<td colspan="4"><?php echo $loc['stats.php']['t12']; ?></td>
		...
		foreach ( $recs as $date => $rec ) 
			...
			<tr class="<?php if ( $cvet & 1 ) {echo 'col2';} else {echo '';} $cvet++; ?>">
				...
				<td><nobr><?php echo $comission_ok; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
				<td><nobr><?php echo $comission_hold; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
				<td><nobr><?php echo $comission_wait; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
				<td><nobr><?php echo $comission_cancel; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
				<td><nobr><?php if ($hosts!='0') {echo round($zakaz_ok/$hosts*100, 0);} else {echo '0';} ?></nobr></td>
				<td><nobr><?php if ($hosts!='0') {echo round($comission_ok/$hosts, 0);} else {echo '0';} ?></nobr></td>
			</tr>
			<?php
			}  
		?>	
		...
		<tr style="background: #e1ecf5;">
			...
			<td width="85"><nobr><?php echo $comission_ok_all; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
			<td width="85"><nobr><?php echo $comission_hold_all; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
			<td width="85"><nobr><?php echo $comission_wait_all; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
			<td width="85"><nobr><?php echo $comission_cancel_all; ?>&nbsp;<?php echo $loc['stats.php']['t26']; ?>&nbsp;</nobr></td>
			<td width="50"><nobr><?php if ($hosts_all!='0'){echo round($zakaz_ok_all/$hosts_all*100, 0);} else {echo '0';}?></nobr></td>
			<td width="50"><nobr><?php if ($hosts_all!='0'){echo round($comission_ok_all/$hosts_all, 0);} else {echo '0';}?></nobr></td>		
		</tr>  		
	</table>
</p>
