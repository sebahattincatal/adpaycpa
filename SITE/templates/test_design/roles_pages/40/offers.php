...
<p>
	...
	if (isset($_GET['xtext']) && $_GET['xtext']=='7') {echo '<font color=green><b>'.$loc['offers.php']['t54'].'</b></font>';} 
	if (isset($_GET['xtext']) && $_GET['xtext']=='8') {echo '<font color=green><b>'.$loc['offers.php']['t55'].'</b></font>';} 
	?>
</p>
...
elseif (isset($_GET['addoffer']) && ($_GET['addoffer']!=''))
	...
	// Add a new offer
	include './templates/'.$template.'/blocks/offers_40_addoffer.php';
	}	
else
	{
