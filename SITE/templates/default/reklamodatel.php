	...
	<main>
		...
		<div class="page-title">
			<div class="container">
				<h1><?php echo $loc['reklamodatel.php']['t01']; ?></h1>
				<span>Sell your product and set any price you want! We will help you!</span>
			</div><!-- container -->
		</div><!-- page-title -->
		...
		<div class="page-module">
			<div class="container">
				<div class="page-module-title text-center">
					<h2><?php echo $loc['reklamodatel.php']['t02']; ?></h2>
				</div><!-- page-module-title -->

				<div class="module-content">
					<img src="assets/images/power-adget.gif">
					<div class="module-text">
						<?php echo $loc['reklamodatel.php']['t03']; ?>
					</div><!-- module-text -->
				</div><!-- module-content -->
