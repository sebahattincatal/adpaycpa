					...
					<div class="row">
						<div class="offers-content">
							<div class="offers-list-header">
								...
								<div class="col-sm-1 col-xs-12 text-center"><span><a href="offers.php?sort_comission=ok" class="normal_link"><?php echo $loc['offers.php']['t157']; ?></a></span></div>
									...
									<li>
										<div class="row">
											...
											<div class="col-sm-1 col-xs-12 text-center">
												...
												if ($offer_active=="0") {?><div class="order-status red"><i class="fa fa-close"></i></div><?}
												?>
