				...
				<div class="asd">
					<div class="row">
						<form id="filter" method="post" action="./stats.php">
							...
							<div class="col-sm-4 form-filter-item">
								<label><?php echo $loc['stats.php']['t05']; ?></label>
								<select name="subid1" class="form-control">
							...
							<div class="col-sm-4 form-filter-item">
								<label><?php echo $loc['stats.php']['t06']; ?></label>
								<select name="subid2" class="form-control">
							...
							<div class="col-sm-4 form-filter-item">
								<label><?php echo $loc['stats.php']['t07']; ?></label>
								<select name="subid3" class="form-control">
