...
// Обработка ситуации при которой был запрос на восстановление утраченных данных
// Processing of the situation in which there was a request for the restoration of lost data
include './lib/recover_email.php';
