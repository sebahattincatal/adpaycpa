...
// Обработка ситуации при которой было добавление нового пользователя
// Processing of the situation in which was the addition of a new user
include './lib/adduser.php';

// Обработка ситуации при которой была передана форма из системной ТДС
// Processing of the situation in which the form of the system was transferred to TDS
