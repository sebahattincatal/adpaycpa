...
// Обработка ситуации при которой были переданы данные с формы тикетов
// Processing situation in which data have been transferred forms ticketing
include './lib/update_tickets.php';
