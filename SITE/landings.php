...
// Обработка ситуации при которой были проведены операции с лендингами
// Processing of the situation in which the operations were carried Landing
include './lib/landings.php';
