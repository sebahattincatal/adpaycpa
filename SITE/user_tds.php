...
// Обработка ситуации при которой была передана форма cо страницы ТДС для вебмастеров
// Processing of the situation in which the form was given to co TDS page for webmasters
include './lib/user_tds.php';
