...
// Обработка ситуации при которой было редактирование данных пользователя
// Processing of the situation in which the user was editing data
include './lib/users_update.php';

// Обработка ситуации при которой была передана форма c системной ТДС
// Processing of the situation in which the form of the system c TDS was transferred
include './lib/system_tds.php';
