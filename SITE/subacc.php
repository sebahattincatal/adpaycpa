...
// Обработка ситуации при которой был запрос на добавление или удаление субаккаунта
// Processing of the situation in which was a request for the addition or removal subaccount
include './lib/update_subacc.php';
