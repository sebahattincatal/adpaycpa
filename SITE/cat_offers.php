...
// Обработка ситуации при которой были бы проведены операции с доменами
// Processing of the situation in which the operations were carried out to domains
include './lib/cat_offers.php';
