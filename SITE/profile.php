...
// Обработка ситуации при которой был запрос на изменение данных профиля
// Processing of the situation in which there was a request to change the profile data
